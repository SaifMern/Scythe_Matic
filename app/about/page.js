...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="container relative z-10 mx-auto">
          ...
          >
            ...
            <motion.p variants={staggerItem} className="page-subtitle mx-auto max-w-3xl">
              We are a modern software company helping businesses design, develop,
              automate, and scale digital products with reliable engineering, clean
              interfaces, and result-focused strategy.
            </motion.p>
      ...
      {/* ── Company Overview ──────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-white px-4 py-10 text-slate-950 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        ...
        <div className="container relative z-10 mx-auto">
          <div className="grid items-stretch gap-10 lg:grid-cols-[1.25fr_0.75fr] lg:gap-12">
            ...
            <motion.div
              ...
              className="rounded-[32px] border border-slate-200 bg-white/90 p-6 shadow-2xl shadow-slate-950/5 backdrop-blur-xl sm:p-8 lg:p-10"
            >
              ...
              <div className="mb-7 border-l-4 border-primary pl-5">
                <p className="text-[clamp(1rem,1.25vw,1.2rem)] font-bold italic leading-[1.6] text-slate-700">
                  ...
                  start their journey toward business growth, digital innovation,
                  and scalable technological transformation.
                </p>
              </div>
              <p className="section-copy text-slate-700">
                Scythematic brings together product strategy, UI engineering,
                custom software development, automation, quality assurance, and
                DevOps under one roof. We work closely with clients to understand
                their goals and create software solutions that are practical,
              ...
              >
                {overviewPoints.map((item, index) => (
                  ...
                  >
                    ...
                    <h3 className="card-title text-slate-950">{item}</h3>
                  </motion.div>
                ))}
              </motion.div>
            </motion.div>
          ...
          >
            {visionMission.map((item) => (
              <motion.div
                key={item.title}
                variants={fadeUp}
                className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.07] hover:shadow-2xl hover:shadow-black/20 sm:p-8 lg:p-10"
              >
                ...
                <div className="relative z-10">
                  <h2 className="section-title mb-7 text-white">{item.title}</h2>
                  <div className="mb-7 border-l-4 border-primary pl-5">
                    <p className="text-[clamp(1.05rem,1.35vw,1.35rem)] font-bold italic leading-[1.55] text-white/90">
                      {item.highlight}
                    </p>
                  </div>
                  <p className="section-copy text-slate-300">{item.description}</p>
                </div>
                <div className="absolute -right-12 -top-12 h-32 w-32 rounded-full bg-primary/10 blur-2xl transition-all duration-500 group-hover:bg-accent/10" />
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="relative overflow-hidden bg-white text-slate-950">
        <div className="grid lg:grid-cols-2">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
            className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-[#092f35] px-4 py-10 text-white sm:px-8 sm:py-14 lg:px-12 lg:py-16 xl:px-16"
          >
            ...
            <div className="relative z-10 mx-auto max-w-2xl lg:mx-0">
              ...
              <div className="space-y-5 section-copy text-slate-300">
                <p>
                ...
                <p>
                  We focus on building strong relationships with clients by
                  combining clear communication, technical expertise, and a
                  result-driven delivery process.
                </p>
              </div>
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
            className="relative overflow-hidden bg-white px-4 py-10 sm:px-8 sm:py-14 lg:px-12 lg:py-16 xl:px-16"
          >
            ...
            <div className="relative z-10 mx-auto max-w-2xl lg:mx-0">
              ...
              <div className="space-y-5 section-copy text-slate-700">
                <p>
                  Over the years, Scythematic has helped businesses improve
                  digital workflows, communication, and operational performance
                  through carefully planned software solutions.
                </p>
                <p>
                  Our clients trust us because we focus on clean execution,
                  scalable systems, responsive support, and solutions that match
                  real business needs.
                </p>
              </div>
              ...
              <div className="mt-10 rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-xl shadow-slate-950/5">
                <p className="text-[clamp(1rem,1.25vw,1.2rem)] font-semibold italic leading-relaxed text-slate-700">
                  "They understood our requirements clearly and delivered a
                  solution that was professional, scalable, and easy for our
                  team to use."
                </p>
                <div className="mt-5">
                  <h4 className="text-base font-bold text-slate-950">Client Feedback</h4>
                  <p className="text-sm text-slate-500">Software Development Project</p>
                </div>
              </div>
            </div>
          </motion.div>
